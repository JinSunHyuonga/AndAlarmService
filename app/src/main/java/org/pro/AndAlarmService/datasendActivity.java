...
public class datasendActivity extends AppCompatActivity {
    ...
    private static String IP_ADDRESS = "211.110.186.9";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.getExtras().getString("textMessages") != null) {
            mEditTextName.setText(intent.getExtras().getString("textMessages"));
        }
        ...
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                task.execute("http://" + IP_ADDRESS + "/android_insert.php", name,country);
        ...
        //화면전환
        Button button_main_return = findViewById(R.id.button_main_return);
        button_main_return.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    class InsertData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(datasendActivity.this,
